...
ALTER SEQUENCE public.planet_types_planet_id_seq OWNED BY public.planet_types.planet_type_id;
...
ALTER TABLE ONLY public.planet_types ALTER COLUMN planet_type_id SET DEFAULT nextval('public.planet_types_planet_id_seq'::regclass);
